...
describe('team environment profiles v0', () => {
  ...
  it('normalizes absolute sample paths to repo-relative source metadata', () => {
    const artifact = buildTeamEnvironmentProfilesV0(
      reports,
      '2026-05-25T00:00:00.000Z',
      null,
      '/workspace/TIBER-Teamstate/data/sample/team_week_raw.sample.json'
    );

    expect(artifact.metadata.inputSources[0]).toEqual({
      path: 'data/sample/team_week_raw.sample.json',
      type: 'sample'
    });
