...
- [`audits/governed-teamstate-artifact-path-for-forecast-run2-2026-06-27.md`](audits/governed-teamstate-artifact-path-for-forecast-run2-2026-06-27.md) — audit/spec (#62) of the governed Teamstate artifact path required before TIBER-Forecast Run 2 can consume TTS: the five-object ladder (candidate inspection → dry-run → rehearsal report → governed artifact → Forecast input), the Forecast-feature-group mapping, the governance/cutoff gates, and the smallest safe artifact shape.
- [`teamstate-forecast-run2-artifact-2024.md`](teamstate-forecast-run2-artifact-2024.md) — the governed Forecast Run 2 input artifact (#66): the upstream evidence packet Forecast #81 waits for, with its recorded 2024 cutoff, explicit-marker governance, source/validation/lineage refs, team-week grain + player-season join posture, field readiness, and pressure/fantasy/leakage exclusions.
- [`formation-lens-v0.md`](formation-lens-v0.md) — spec (#75) for a future human-readable Formation Lens over Data-owned shotgun vs. under-center summaries, including the Teamstate/Data boundary, upstream artifact expectations, reader-facing explanation shape, derivation risks, and next-issue recommendation.
